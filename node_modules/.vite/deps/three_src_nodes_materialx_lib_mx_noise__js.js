...
var ColorSpaceNode = class extends TempNode_default {
  ...
  setup(builder) {
    const { renderer, context: context2 } = builder;
    const source = this.source || context2.outputColorSpace || renderer.outputColorSpace;
    const target = this.target || context2.outputColorSpace || renderer.outputColorSpace;
...
var toOutputColorSpace = (node, colorSpace = null) => nodeObject(new ColorSpaceNode(nodeObject(node), colorSpace, LinearSRGBColorSpace));
var toWorkingColorSpace = (node, colorSpace = null) => nodeObject(new ColorSpaceNode(nodeObject(node), LinearSRGBColorSpace, colorSpace));
...
var RenderOutputNode = class extends TempNode_default {
  ...
  setup({ context: context2 }) {
    ...
    const outputColorSpace = (this.outputColorSpace !== null ? this.outputColorSpace : context2.outputColorSpace) || LinearSRGBColorSpace;
